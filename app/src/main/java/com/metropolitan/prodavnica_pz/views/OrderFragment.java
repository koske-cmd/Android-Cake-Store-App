...
import com.metropolitan.prodavnica_pz.databinding.FragmentOrderBinding;
...
public class OrderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentOrderBinding.nastaviKupovinuButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                shopViewmodel.resetCart();
                navController.navigate(R.id.action_orderFragment_to_startFragment);
            }
        });
    }
}